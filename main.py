...
def parse_args():
    ...
    parser.add_argument('--input_w', type=int, default=1208, help='Resized image width')  # used to be 608
    parser.add_argument('--K', type=int, default=500, help='Maximum of objects')
    parser.add_argument('--conf_thresh', type=float, default=0.35, help='Confidence threshold, 0.1 for general evaluation') # for train=0.18
